...
gdjs.IntroCode.asyncCallback12559420 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.IntroCode.asyncCallback12559420(runtimeScene, asyncObjectsList)));
}
}
